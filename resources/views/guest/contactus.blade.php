    ...
    <section class="py-5 contact-us">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-md-12 p-5 bg-white rounded-3">
            <div class="d-flex flex-column">
              <h2 class="h5 text-capitalize">Contact us</h2>
              <p>
            ...
            @endif
            <form class="row mb-3 rd-mailform" data-form-output="form-output-global" data-form-type="contact" method="POST" action="{{ route('contactus') }}">   
              ...
              <div class="col-md-3 p-3">
					...
					<select class="input-block-level form-control col-md-6"  id="countryCode" name="countryCode"  onchange="myFunction(this)">
        ...
        <option data-countryCode="ZW" value="263">&#x1F1FF&#x1F1FC Zimbabwe (+263)</option>
			...
			<div class="col-md-3 p-3"> <input required placeholder="phone" type="tel" name="phone" data-constraints="@@Numeric @@Required" />
              </div>
              <div class="col-md">
                <textarea
                  required
			  ...
			  <input type="hidden" name="recaptcha" id="recaptcha">
                <button type="submit" class="btn enquire-btn">
                  Send Message
                </button>
              </div>
            </form>
            ...
            <div class="d-flex flex-column px-0">
              <ul class="m-0 p-0">
                ...
                >
                  ...
                  <span><a href="tel:919216325377">+(91)-92163-25377</a></span>
                </li>
                <li class="d-flex align-items-center r mb-4">
                  <span class=" d-flex align-items-center me-3 fs-2">
                    <i class="fa fa-envelope"></i>
                  </span>
                  <span><a href="mailto:info@rsmmultilink.com">info@rsmmultilink.com</a></span> 
                </li>
                <li
                  class="d-flex justify-content-start align-items-center mb-4"
                >
	   ...
	   @php $recaptchaSiteKey = config('services.recaptcha.sitekey'); @endphp
	   <script src="https://www.google.com/recaptcha/api.js?render={{ $recaptchaSiteKey }}"></script>
        <script>
            var recaptchaSiteKey = "{{ $recaptchaSiteKey }}";
            // Generate fresh token on form submit (not on page load - tokens expire in 2 min)
            document.querySelector('form.rd-mailform').addEventListener('submit', function(e) {
                e.preventDefault();
                var form = this;
                grecaptcha.ready(function() {
                    grecaptcha.execute(recaptchaSiteKey, {action: 'contactus'}).then(function(token) {
