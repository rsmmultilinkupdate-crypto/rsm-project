...
@section('content')
<div class="card">
    <div class="card-header">Product Categories - View All <a href="{{ route('productcategories.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
