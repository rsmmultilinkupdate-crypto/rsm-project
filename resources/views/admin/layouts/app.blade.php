                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li><a class="nav-link" href="{{ route('cms.index') }}">CMS</a></li>
                            <li><a class="nav-link" href="{{ route('testimonial.index') }}">Testimonal</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown1">
                                    ...
                                    <a class="nav-link" href="{{ route('productcategories.index') }}">Categories</a>
                                    <a class="nav-link" href="{{ route('subproductcategories.index') }}">Sub-Categories</a>
                                </div>
                            </li>
