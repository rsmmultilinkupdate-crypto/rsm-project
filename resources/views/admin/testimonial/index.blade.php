...
@section('content')
<div class="card">
    <div class="card-header">Testimonial - View All  <a href="{{ route('testimonial.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
...
$(document).ready(function() {
    $('#dataTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No Testimonial Found, Create the first testimonial.",
            "oPaginate": {
