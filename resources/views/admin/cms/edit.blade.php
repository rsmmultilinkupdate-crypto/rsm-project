...
@section('content')
<div class="card">
    <div class="card-header">CMS - Edit <a href="{{ route('cms.index') }}" class="btn btn-light float-right btn-sm "><i class="fas fa-chevron-left"></i> Go Back</a></div>

    <div class="card-body">
        <form method="post" action="{{ route('cms.update', $blog->id) }}" enctype="multipart/form-data" novalidate>
            @csrf
            {{ method_field('PUT') }}
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="slug" name="slug" value="{{ old('slug', $blog->slug) }}" placeholder="Slug" onkeyup="countChar(this, 'charNumTitle1', 125)" maxlength="125" required>
