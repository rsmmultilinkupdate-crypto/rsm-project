...
@section('content')
<div class="card">
    <div class="card-header">CMS - View All  <a href="{{ route('cms.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
...
$(document).ready(function() {
    $('#dataTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No Page Found, Create the first Page.",
            "oPaginate": {
        ...
        serverSide: true,
        ajax: '{!! route('cms.ajaxData') !!}',
        columns: [
            { data: 'bulkAction', name: 'bulkAction' },
            { data: 'id', name: 'cms.id' },
            { data: 'title', name: 'cms.title' },
            { data: 'users.name', name: 'users.name' },
            { data: 'created_at', name: 'cms.created_at' },
            { data: 'is_active', name: 'cms.is_active' },
