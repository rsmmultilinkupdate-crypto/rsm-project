            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $blog->title) }}" placeholder="Write something beautiful today..." onkeyup="countChar(this, 'charNumTitle', 125)" maxlength="125" required>
