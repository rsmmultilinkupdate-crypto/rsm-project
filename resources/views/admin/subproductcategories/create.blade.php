...
@section('content')
<div class="card">
    <div class="card-header">Sub Product Categories - Add New <a href="{{ route('productcategories.index') }}" class="btn btn-light float-right btn-sm "><i class="fas fa-chevron-left"></i> Go Back</a></div>

    <div class="card-body">
        <form method="post" action="{{ route('subproductcategories.store') }}" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row">
                <div class="col-md-5">
