...
@section('content')
<div class="card">
    <div class="card-header">Sub Product Categories - View All <a href="{{ route('subproductcategories.create') }}" class="btn btn-primary float-right btn-sm mr-2"><i class="fas fa-plus"></i> Add</a></div>
...
$(document).ready(function() {
    $('#dataTable').DataTable({
        ...
        "language": {
            ...
            "emptyTable": "No Sub Categories Found, Create the first sub category.",
            "oPaginate": {
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    if (confirm('Are you sure?')) {
                        ...
                        window.location.href = '{{ route("pcategoriesData.bulkDelete") }}?ids=' + selectedIds;
                    }
                },
