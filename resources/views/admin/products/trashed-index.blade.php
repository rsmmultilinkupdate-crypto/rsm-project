...
@section('content')
<div class="card">
    <div class="card-header">Products - Trashed <a href="{{ route('products.index') }}" class="btn btn-light float-right btn-sm mr-2"><i class="fas fa-chevron-left"></i> Go Back</a></div>
        ...
        buttons: [
            {
                ...
                action: function ( e, dt, node, config ) {
                    if (confirm('Are you sure?')) {
                        window.location.href = '{{ route("products.emptyTrash") }}';
                    }
                },
            ...
            },
            {
                ...
                action: function ( e, dt, node, config ) {
                    if (confirm('Are you sure?')) {
                        ...
                        window.location.href = '{{ route("products.bulkRestore") }}?ids=' + selectedIds;
                    }
                },
                init: function (dt, node, config) {
