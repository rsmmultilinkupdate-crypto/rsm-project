...
@section('content')
<div class="card">
    <div class="card-header">Products - Add New <a href="{{ route('products.index') }}" class="btn btn-light float-right btn-sm "><i class="fas fa-chevron-left"></i> Go Back</a></div>
        ...
        <form method="post" action="{{ route('products.store') }}" enctype="multipart/form-data" novalidate>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="image">Multiple Image (Optional)</label>
                        <input type="file" name="multipleimage[]" multiple class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="subcategories" name="subcategories[]"  multiple>
                            @if (is_array(old('subcategories')))
                                @foreach (old('subcategories') as $oldCategory)
                                <option value="{{ $oldCategory }}" selected="selected">
                                    @if(is_numeric($oldCategory))
                    ...
                    <div class="form-group">
                        ...
                        <input style="width: 100%;"  class="form-control" placeholder="Tags" data-role="tagsinput" type="text" name="tags" >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="new_launches" name="new_launches" required>
                            <option value="0" @if(old('new_launches', '0') == '0') selected @endif>No</option>
                            <option value="1" @if(old('new_launches') == '1') selected @endif>Yes</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="is_active">Hot Offers <span class="required">*</span></label>
                        <select class="form-control" id="hot_offers" name="hot_offers" required>
                            <option value="0" @if(old('hot_offers', '0') == '0') selected @endif>No</option>
                            <option value="1" @if(old('hot_offers') == '1') selected @endif>Yes</option>
                        </select>
                    </div>
