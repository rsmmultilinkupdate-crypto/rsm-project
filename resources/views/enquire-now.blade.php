		...
		<div class="custom-model-inner">        
			...
			<div class="custom-model-wrap">
				<div class="pop-up-content-wrap">
					...
					<form data-action="{{ route('enquire') }}" class="form-horizontal" id="submitdataform" method="post" action="">
						...
						<div class="enq-form">
							...
							<div class="md-form form-group" bis_skin_checked="1">
								...
								<input  type="text" class="form-control validate" id="product-name" product-name="{{ $product_details->title }}" name="product" value="{{ $product_details->title }}" readonly>
							</div>
							<div class="form-group">
